...
export const RACES: FiveERace[] = [
    {
        ...
        imageUrl: 'assets/images/races/aasimar.jpg',
        speed: 30,
        size: [150, 200],
    ...
    },
    {
        ...
        imageUrl: 'assets/images/races/gnome.jpg',
        speed: 25,
        size: [120, 150],
        creatureType: CreatureType.Humanoid,
        traits: [
    ...
    },
    {
        ...
        imageUrl: 'assets/images/races/goliath.jpg',
        speed: 30,
        size: [210, 240],
        creatureType: CreatureType.Humanoid,
        traits: [
    ...
    },
    {
        ...
        imageUrl: 'assets/images/races/half-elf.jpg',
        speed: 30,
        size: [160, 180],
        creatureType: CreatureType.Humanoid,
        traits: [
    ...
    },
    {
        ...
        imageUrl: 'assets/images/races/orc.jpg',
        speed: 30,
        size: [180, 210],
        creatureType: CreatureType.Humanoid,
        traits: [
